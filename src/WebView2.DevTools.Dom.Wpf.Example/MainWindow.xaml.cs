    ...
    public partial class MainWindow : System.Windows.Window
    {
        ...
        private async void OnWindowLoaded(object sender, RoutedEventArgs e)
        {
            ...
            webView.CoreWebView2.DOMContentLoaded += async (s, e) =>
            {
                ...
                var csAlertButton = await devToolsContext.QuerySelectorAsync<HtmlButtonElement>("#csAlertButton");
                ...
                var currentTimeSpan = await devToolsContext.QuerySelectorAsync<HtmlSpanElement>("#current-time");
                var fpsSpan = await devToolsContext.QuerySelectorAsync<HtmlSpanElement>("#fps");
